        ...
        <div class="row">
            <div class="col-md-6">
                <div class="group-input">
                    ...
                    <select id="choices-multiple-remove-button" class="choices-multiple-reviewer" name="drafters[]" placeholder="Select Drafter" multiple required>
                        @if (!empty($drafter))
            ...
            <div class="col-md-6">
                <div class="group-input">
                    ...
                    <select id="choices-multiple-remove-button" class="choices-multiple-reviewer" name="hods[]" placeholder="Select HOD/CFTs" multiple required>
                        @foreach ($hods as $hod)
                        <option value="{{ $hod->id }}">
                            {{ $hod->name }}
                        </option>
