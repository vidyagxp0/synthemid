...
@section('rcms_container')
    ...
    <div id="rcms-desktop">
        <div class="process-groups">
            <div class="active" onclick="openTab('internal-audit', this)">Pending Approver Log</div>
        </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-2" style="margin-left:-50px; margin-bottom:12px">
                                    <div class="filter-bar">
                                        ...
                                        <div class="filter-item">
                                            <label for="date_from_PendingApprover">Date From</label>
                                            <input type="date" class="custom-select" id="date_from_PendingApprover">
                                        </div>
                                        <div class="filter-item">
                                            <label for="date_to_PendingApprover">Date To</label>
                                            <input type="date" class="custom-select" id="date_to_PendingApprover">
                                        </div>
                                        <!-- <div class="filter-item">
                                        ...
                                        <div class="filter-item">
                                            <label for="datewise_PendingApprover">Select Period</label>
                                            <select class="custom-select" id="datewise_PendingApprover">
    ...
    <script>
        ...
        const filterData = {
            ...
            division_idPendingApprover: null,
            date_fromPendingApprover: null,
            date_toPendingApprover: null,
            // audit_type: null,
            period: null
        };
        ...
        $('#division_id').change(function() {
            filterData.division_idPendingApprover = $(this).val();
            filterRecords();
        });
        ...
        $('#date_from_PendingApprover').change(function() {
            filterData.date_fromPendingApprover = $(this).val();
            filterRecords();
        });

        $('#date_to_PendingApprover').change(function() {
            filterData.date_toPendingApprover = $(this).val();
            filterRecords();
        });

        $('#datewise_PendingApprover').change(function() {
        ...
        async function filterRecords() {
            ...
            try {
                const postUrl = "{{ route('api.pendingApprover.filter') }}";
